...
- [Public site performance](public-site-performance.md) — hero images must be WebP not PNG; App.tsx pages must stay React.lazy() code-split or the public bundle re-bloats with the whole ERP.
